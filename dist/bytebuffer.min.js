...
*/
(function(h,l){module['exports'] = l(require("long"))})(this,function(h){function l(a){var b=0;return function(){return b<a.length?a.charCodeAt(b++):null}}function t(){var a=[],b=[];return function(){if(0===arguments.length)return b.join("")+x.apply(String,a);1024<a.length+
